...
public class FlightServiceImplShould {
    ...
    void check_flight_exists_before_increasing_seats() {
        assertThrows(FlightNotFoundException.class, () -> flightService.increaseSeatsLeft("555", 10), "555");
    ...
    void check_flight_exists_before_decreasing_seats() {
        assertThrows(FlightNotFoundException.class, () -> flightService.decreaseSeatsLeft("555", 10), "555");
    ...
    void throw_no_such_flight_exception_if_a_flight_does_not_exist() {
        assertThrows(FlightNotFoundException.class, () -> flightService.get("123"), "123");
